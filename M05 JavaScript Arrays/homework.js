...
function dePalabrasAFrase(palabras) {
   ...
   // Tu código:
   let dePalabrasAFrase = palabras.join (' ')
...
function arrayContiene(array, elemento) {
   ...
   // Tu código:
   let arrayContiene = array.includes(elemento)
...
function cuentoElementos(array) {
   ...
   array.forEach(element => {
      if (element > 18) newArray.push(element); 
   });
...
function tablaDelSeis() {
   ...
   var tablaresultado = tabla.map((element) => {return element * 6})
...
function mayorACien(array) {
   ...
   let mas100 = [];
   array.forEach(element => {
      if (element > 100) mas100.push(element); 
   });
   return mas100
}
